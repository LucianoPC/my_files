...
USER_DISTRO="${DARK_GREEN}[${GREEN}\u${DARK_GREEN}]"
...
if [ "$color_prompt" = yes ]; then
    ...
    # PS1='[$?]${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u:\[\033[01;34m\]\w\[\033[00m\]\$ '
		PS1="${DARK_GREEN}\342\224\214\342\224\200[\`${SELECT}\`${DARK_GREEN}]-${USER_DISTRO}-[${BLUE}\w${DARK_GREEN}]${GIT_BRANCH}${DARK_GREEN}\n${DARK_GREEN}\342\224\224\342\224\200> \$ ${NORMAL}"
else
...
alias ap='mkalias_ap'
function mkalias_ap(){ cd ~/Documents/unb/tcc/AppRecommender/bin; ./apprec.py $@; cd -; }
...
alias cdgithelper='mkalias_cdgithelper'
function mkalias_cdgithelper(){ cd ~/Documents/projects/githelper $@; }

alias guf='mkalias_guf'
function mkalias_guf(){ git --no-pager diff --name-only --diff-filter=U $@; }
...
alias ipt='mkalias_ipt'
function mkalias_ipt(){ ipython $@; }
